...
public class PaginaMoto extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        out.println("<br><br><br>");
        out.println("<a href=\"http://localhost:8080/TallerJakartaServlets/Ducati\">Pagina Ducati</a>");
        out.println("<br><br><br>");
        out.println("<h1>Kawasaki</h1>");
        out.println("<a href=\"http://localhost:8080/TallerJakartaServlets/Kawasaki\">Pagina Kawasaki</a>");
        out.println("<br><br><br>");
        out.println("<h1>Suzuki</h1>");
        out.println("<a href=\"http://localhost:8080/TallerJakartaServlets/Suzuki\">Pagina Suzuki</a>");
        out.println("<br><br><br>");
        out.println("</body>");
        out.println("</html>");
    }
